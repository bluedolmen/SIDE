...
%>
<%script type="WebSite.Component" name="dataPage_component_update_namefile"%>
<%if ((canCreate)||(canUpdate)){%><%eContainer().eContainer().name%>/edit_<%table.name%>_<%eContainer().name%><%}%>
<%-- condition can_update or can_create --%>
<%script type="WebSite.Component" name="dataPage_component" file="<%dataPage_component_update_namefile%>"%>
<html>
	<head>
		<title><%name%></title>
...
<%script type="WebSite.Component" name="dataPage_component_sqlQueryUpdate"%>
...
<%script type="WebSite.Component" name="dataPage_component_create_update"%>
