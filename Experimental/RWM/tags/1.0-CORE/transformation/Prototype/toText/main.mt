...
%>
<%script type="WebSite.LoginPage" name="loginPage" file="<%eContainer().name%>/<%name%>"%>
<html>
	<head>
		<title><%title%></title>
...
<%script type="WebSite.FramePage" name="goalPage_frame" file="<%eContainer().name%>/<%name%>"%>
<frameset cols="20%,80%" frameborder="no">
	<frame src="<%col1.name%>" name="goalItems">
	<frame name="data">
</frameset>
<%script type="WebSite.GoalPage" name="goalPage_list" file="<%eContainer().name%>/<%name%>"%>
<html>
	<head>
		<title><%title%></title>
		<link rel="stylesheet" type="text/css" href="css/main.css">
...
<%script type="WebSite.GoalItem" name="goalPage_goalItem"%>
<ul>
...
<%script type="WebSite.DataPage" name="dataPage" file="<%eContainer().name%>/<%name%>"%>
<html>
	<head>
		<title><%title%></title>
		<link rel="stylesheet" type="text/css" href="css/main.css">
...
<%script type="WebSite.Component" name="dataPage_component"%>
<div id="component">
...
<%script type="WebSite.Component" name="dataPage_component_read"%>
	<table>
		<tr>
...
<%script type="WebSite.Component" name="dataPage_component_sqlQuery"%>
