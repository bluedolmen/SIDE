 ...
 * @author davidabad
 */
public class CascadeDeletePolicy implements BeforeDeleteNodePolicy {
	// Behaviours
	...
	public void beforeDeleteNode(NodeRef nodeRef) {
		if (StoreRef.STORE_REF_WORKSPACE_SPACESSTORE.equals(nodeRef.getStoreRef()) && nodeService.getType(nodeRef).getNamespaceURI().startsWith(ContentModel.BXCONTENT_NAMESPACE_PREFIX)) {
