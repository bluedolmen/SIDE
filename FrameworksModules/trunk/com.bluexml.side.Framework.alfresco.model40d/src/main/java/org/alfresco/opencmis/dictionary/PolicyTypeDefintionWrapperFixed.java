...
public class PolicyTypeDefintionWrapperFixed extends AbstractTypeDefinitionWrapper
{
    ...
    public PolicyTypeDefintionWrapperFixed(CMISMapping cmisMapping, PropertyAccessorMapping propertyAccessorMapping, 
            ...
            DictionaryService dictionaryService)
    {
        ...
        } else
        {
        	...
        	// let custom aspect to be registered
            if (!isBaseType() && dictionaryService.getAspect(alfrescoClass) == null)
            {
