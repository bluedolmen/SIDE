...
SIDE.languagePicker =
{
   loadShareDashboardWithLang : function(lang) {
      ...
      if (params.length > 0)
      {
         ...
         else
         {
            ...
            if (end == -1)
               ...
               searchString = params.substring(0, position + 10) + lang
                     + params.substring(end);
         }
      } else
         searchString = "?shareLang=" + lang

      window.location.href = window.location.protocol + "//"
            + window.location.host + window.location.pathname + searchString;
   },
      ...
      var responseConfig =
      {
         ...
         successCallback :
         {
            fn : function(response, obj) {
               SIDE.languagePicker.loadShareDashboardWithLang(lang);
            },
            scope : this
         }
      };
