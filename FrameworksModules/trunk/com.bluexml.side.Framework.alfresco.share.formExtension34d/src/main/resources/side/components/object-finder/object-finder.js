...
(function()
{
   ...
   {
      SIDE.ObjectFinder.superclass.constructor.call(this, "SIDE.ObjectFinder", htmlId, ["button", "menu", "container", "resize", "datasource", "datatable"]);
   ...
   YAHOO.extend(SIDE.ObjectFinder, Alfresco.component.Base,
   {
      /**
       ...
       * @return {SIDE.ObjectFinder} returns 'this' for method chaining
       */
      setOptions: function ObjectFinder_setOptions(obj)
      {
         SIDE.ObjectFinder.superclass.setOptions.call(this, obj);
      ...
      {
         SIDE.ObjectFinder.superclass.setMessages.call(this, obj);
