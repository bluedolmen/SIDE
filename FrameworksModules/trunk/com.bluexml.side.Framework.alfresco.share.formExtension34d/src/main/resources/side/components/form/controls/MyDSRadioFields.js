...
(function() {
   ...
   YAHOO.lang.extend(SIDE.MyDSRadioFields, inputEx.RadioField, {
      ...
      reload : function(mode, addedValue) {
         ...
         this.log("reload sendDataRequest :");
         this.log("reload sendDataRequest mode :" + this.reloadData.mode);
         this.log("reload sendDataRequest added :" + this.reloadData.added);
      ...
      renderComponent : function() {
         ...
         this.log("renderComponent sendDataRequest");
