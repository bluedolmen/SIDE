...
(function()
{
   ...
   YAHOO.extend(Alfresco.AdvancedSearch, Alfresco.component.Base,
   {
      ...
      onReady: function ADVSearch_onReady()
      {
         ...
         // form = {description: '', id: '', label:'', type: 'Kinedoc:org_kinedoc_ActeDeCongres'}
      ...
      renderFormTemplate: function ADVSearch_renderFormTemplate(form, repopulate)
      {
         ...
         if (!form.htmlid)
         {
            ...
            //Dom.addClass(formDiv, form.id + '-' + form.type.replace(/:/, '_'))
            ...
            YAHOO.plugin.Dispatcher.init ({relative: true});
            YAHOO.plugin.Dispatcher.fetch (htmlid, formUrl + '&htmlid=' + htmlid, {action: 'add'});
