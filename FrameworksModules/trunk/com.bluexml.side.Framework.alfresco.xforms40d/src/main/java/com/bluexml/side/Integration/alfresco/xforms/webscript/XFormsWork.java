...
public class XFormsWork implements RunAsWork<String> {
	 ...
	 *         string for the node,
	 *         e.g.
	 *         "workspace://SpacesStore/ca151555-95e0-4361-aa4e-0050adb7027d{::}John Doe (johndoe@email.com){::}cm:person"
	 */
	...
	private Object callAuthorityDAO(String methodName, List<Object> methodParams) throws SecurityException {
		...
		if (StringUtils.equals(methodName, "getAllAuthorities")) {
			...
			return authorityDAO.getAllAuthoritiesInZone(AuthorityService.ZONE_APP_DEFAULT, authorityType);
		}
