...
{
   /**
	 * Type map to filter required types. NOTE: "documents" filter also returns
	 * folders to show UI hint about hidden folders.
	 */
   TYPE_MAP:
   {
   ...
   getFilterParams: function Filter_getFilterParams(filter, parsedArgs, optional)
   {
      ...
      // Common types and aspects to filter from the UI - known subtypes of
		// cm:content and cm:folder
