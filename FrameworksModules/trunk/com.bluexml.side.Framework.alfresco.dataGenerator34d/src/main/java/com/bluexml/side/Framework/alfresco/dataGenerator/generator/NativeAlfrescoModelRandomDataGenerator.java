...
public class NativeAlfrescoModelRandomDataGenerator {
	 ...
	 */
	public Map<QNamePattern,Object> generateNativeDatasProperties(ClassDefinition type) {
	 ...
	 */
	private Object fillNativeDataProperty(QNamePattern property, ClassDefinition type) {
	 ...
	 */
	private String generateName(ClassDefinition type) {
		String name = null;
	 ...
	 */
	private String generateUrl(ClassDefinition type){
	 ...
	 */
	public Map<QNamePattern,Object> generateNativeDatasAspects(ClassDefinition type){
	 ...
	 */
	private Object fillNativeDataAspect(QNamePattern aspect, ClassDefinition type) {
		Object data = new Object();
