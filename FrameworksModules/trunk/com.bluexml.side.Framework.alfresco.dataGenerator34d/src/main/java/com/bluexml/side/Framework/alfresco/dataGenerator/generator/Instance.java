...
public class Instance implements IInstance {
	...
	/**
	 * @param alfrescoModelRandomGenerator
	 *            the alfrescoModelRandomGenerator to set
	 */
	public void setAlfrescoModelRandomGenerator(IRandomGenerator alfrescoModelRandomGenerator) {
	...
	/**
	 * @param alfrescoModelDatasInstance
	 *            the alfrescoModelDatasInstance to set
	 */
	 ...
	 * @throws Exception
	 */
	public INode instanciation(Object typeObject) throws Exception {
		INode nodeInstance = null;
		if (typeObject instanceof ClassDefinition) {
			ClassDefinition type = (ClassDefinition) typeObject;
			nodeInstance = new AlfrescoNode();
			...
			while (services.checkUnicity(type, sideDataProperties, sideAspectDataProperties)) {
			...
			((AlfrescoNode) nodeInstance).setClassDefinition(type);
		} else {
			throw new Exception("typeObject is not a ClassDefinition !");
		}
