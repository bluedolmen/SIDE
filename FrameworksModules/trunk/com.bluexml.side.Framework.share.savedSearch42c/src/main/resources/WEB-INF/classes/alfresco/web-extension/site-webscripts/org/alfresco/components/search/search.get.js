<import resource="classpath:alfresco/web-extension/site-webscripts/com/bluexml/commons/utils-args.js">
/**
...
function main()
{
   ...
   var search = {
      ...
      options : {
         ...
         enableSavedSearch: SIDE.args.paramValide("enableSavedSearch","false"),
         savedSearchDataType: SIDE.args.paramValide("savedSearchDataType",""),
         enableExport: SIDE.args.paramValide("enableExport","false"),
         exportType: SIDE.args.paramValide("exportType",""),
         exportViewName: SIDE.args.paramValide("exportViewName",""),
         savedSearchVisibility: SIDE.args.paramValide("savedSearchVisibility","public"),
         savedSearchAllowOverride: SIDE.args.paramValide("savedSearchAllowOverride","false")
      }
   };
