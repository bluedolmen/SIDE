 ...
 * @author davidc
 */
public class CustomJBPMJpdlXmlReader extends JpdlXmlReader
{
    private static final long serialVersionUID = -753730152120696221L;
    private static Log logger = LogFactory.getLog(CustomJBPMJpdlXmlReader.class);

    /*
     * Construct
     */
    public CustomJBPMJpdlXmlReader(InputStream inputStream)
    {
     ...
     * Construct
     */
    public CustomJBPMJpdlXmlReader(InputSource inputSource, ProblemListener problemListener)
    {
     ...
     * Construct
     */
    public CustomJBPMJpdlXmlReader(InputSource inputSource)
    {
        super(inputSource);
    }
     ...
     * Construct
     */
    public CustomJBPMJpdlXmlReader(Reader reader)
    {
        super(reader);
    }
    ...
    protected void readNodeTimer(Element timerElement, Node node)
    {
        ...
        if (logger.isDebugEnabled()) logger.debug("Create Timer using BX CustomCreateTimerAction");
       
        CreateTimerAction createTimerAction = new CustomCreateTimerAction();
    ...
    protected void readTaskTimer(Element timerElement, Task task)
    {
        ...
        if (logger.isDebugEnabled()) logger.debug("Create Task Timer using BX CustomCreateTimerAction");
