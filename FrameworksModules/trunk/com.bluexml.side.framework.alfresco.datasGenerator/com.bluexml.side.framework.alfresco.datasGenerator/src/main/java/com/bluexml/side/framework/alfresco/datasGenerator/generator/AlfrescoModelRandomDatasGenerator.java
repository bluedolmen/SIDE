...
import com.bluexml.side.framework.alfresco.datasGenerator.dictionary.IDictionary;
 ...
 *
 */
public class AlfrescoModelRandomDatasGenerator implements IRandomGenerator {
	...
	public boolean generateNodesInstances(IStructure structure){
		...
		((AlfrescoModelDatas) alfrescoModelDatas).setGeneratedTypesInstances(nodesInstances);
		return true;
	}
	...
	public void generateArcsInstances(IStructure structure){
		if (generateNodesInstances(structure)){
			...
			((AlfrescoModelDatas) alfrescoModelDatas).setGeneratedAssociationsInstances(arcsInstances);
		}
		else{
			//throws Exception
		}
