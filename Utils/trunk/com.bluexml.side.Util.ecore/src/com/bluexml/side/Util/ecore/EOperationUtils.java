...
public class EOperationUtils {
	...
	/**
	 * This method retrun strue if otehrEop is similar to eop
	 * method is transitive (normally)
	 * EOperations are similar if 
	 *  <ol><p>EOperations are similar if </p>
	 *  <li>They have exactly the same return type</li>
	 *  <li>They have the same name</li>
	 *  <li>they have the same number of parameters</li>
	 *  <li><code>each parameter</code> from an <code>EOperation</code> is of same type or is subType from the same parameter at the same
	 *  position in the other <code>EOperation</code></li>
	 *  </ol>
	 * @param eop     first Eoperation
	 * @param otherEop other Eoperation
	 * @return
	 */
	...
	/**
	 * returns true, if second method argument is the same type or a subType of first method argument
	 * @param epaType
	 * @param epaSubType
	 * @return
	 */
	protected static boolean isSubType(EParameter epaType, EParameter epaSubType ){
		...
		// cast in EClassImpl because its impossible to get SuperType from an EClassifier
