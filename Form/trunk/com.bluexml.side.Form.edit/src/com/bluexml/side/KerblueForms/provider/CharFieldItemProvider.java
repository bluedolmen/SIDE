...
/**
 * This is the item provider adapter for a {@link com.bluexml.side.KerblueForms.CharField} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CharFieldItemProvider
	...
	public String getText(Object object) {
		String label = ((CharField)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_CharField_type") :
			getString("_UI_CharField_type") + " " + label;
	}
