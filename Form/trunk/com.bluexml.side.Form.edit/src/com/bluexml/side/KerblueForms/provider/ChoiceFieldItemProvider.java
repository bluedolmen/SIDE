...
/**
 * This is the item provider adapter for a {@link com.bluexml.side.KerblueForms.ChoiceField} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChoiceFieldItemProvider
	...
	public String getText(Object object) {
		String label = ((ChoiceField)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_ChoiceField_type") :
			getString("_UI_ChoiceField_type") + " " + label;
	}
