...
/**
 * This is the item provider adapter for a {@link com.bluexml.side.KerblueForms.FormClass} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FormClassItemProvider
	...
	public String getText(Object object) {
		String label = ((FormClass)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_FormClass_type") :
			getString("_UI_FormClass_type") + " " + label;
	}
