...
<%if (eContainer() == null) {%><%getProperty("alf.share.paths.core.site-webscripts")%>org/alfresco/components/documentlibrary/repo-documentlist.get_de.properties<%}%>
...
details.categories=Kategorien
details.categories.none=(Kein)
...
details.banner.locked=Dieses Dokument ist von {0} gesperrt.
...
## Tips
tip.active-workflow=Geh\u00f6rt zu {0} aktiven Workflows
...
tip.google-docs-owner=Von Ihnen zur Bearbeitung in Google Text & Tabellen&trade; gesperrt
tip.google-docs-locked=Von {0} ({1}) zur Bearbeitung in Google Text & Tabellen&trade; gesperrt
...
message.delete.failure=''{0}'' kann nicht gel\u00f6scht werden
...
message.empty=Keine Dateien
message.empty.subfolders=Keine Dateien. "{0}" anklicken, um {1} Unterordner hier zu sehen.
...
message.simple-workflow.failed=Die Workflow-Aktion konnte nicht abgeschlossen werden.
message.checkout-google.inprogress=''{0}'' wird nach Google Text & Tabellen ausgecheckt
message.checkout-google.success=''{0}'' wurde in Google Text & Tabellen eingef\u00fcgt
message.checkout-google.failure=Konnte ''{0}'' nicht in Google Text & Tabellen einchecken
message.checkout-google.failure=Sie k\u00f6nnen ''{0}'' nicht nach Google Text & Tabellen auschecken
message.checkin-google.inprogress=''{0}'' wird von Google Text & Tabellen eingecheckt
message.checkin-google.success=''{0}'' wurde von Google Text & Tabellen eingecheckt
message.checkin-google.failure=Sie k\u00f6nnen ''{0}'' nicht von Google Text & Tabellen einchecken
