...
public class ApplicationModelInitializer extends ModelInitializer {
	...
	private static final String APPLICATION_EDITOR_ID = "com.bluexml.side.application.presentation.ApplicationEditorID";
	...
	public ApplicationModelInitializer(IFile classModel, ClassPackage root, InitializerRegister register, ASK_USER ask, String fileName, String alfrescoVersion, String alfrescoHome) throws IOException {
		super(classModel, root, ModelInitializationUtils.getExtensionForExtensionId(APPLICATION_EDITOR_ID), "application", register, ask, fileName);
	...
	private void createConfiguration(Application app) {
		...
		createConfigurationParameter(conf, "Directory", "CATALINA_HOME", alfrescoHome);
	...
	private void createConfigurationParameters(Configuration conf, String projectName) {
		createConfigurationParameter(conf, "", "generation.options.logPath", "/" + projectName + "/build/logs");
		createConfigurationParameter(conf, "", "generation.options.destinationPath", "/" + projectName + "/build/generated");
		createConfigurationParameter(conf, "", "generation.options.clean", "true");
	}

	private void createDeployersConfigurations(Configuration conf) {
		List<String> options = new ArrayList<String>();
		options.add("com.bluexml.side.Deployer.alfrescoDirectCopy34d.clean");
		createDeployerConfiguration(conf, "com.bluexml.side.Deployer.alfrescoDirectCopy34d", options);
	}
	...
	private void createGeneratorsConfigurations(Configuration conf) {
		if (alfrescoVersion.equals(AlfrescoVersions.COMMUNITY_34D.toString())) {
			...
			options_class.add("alfresco.share.extension");
			createGeneratorConfiguration(conf, "com.bluexml.side.Class.generator.alfresco34d", options_class);
			List<String> options_portal = new ArrayList<String>();
			options_portal.add("com.bluexml.side.Portal.generator.alfresco.forms");
			options_portal.add("com.bluexml.side.Portal.generator.alfresco.doclist");
			createGeneratorConfiguration(conf, "com.bluexml.side.Portal.generator.alfresco3.4d", options_portal);
			createGeneratorConfiguration(conf, "com.bluexml.side.View.generator.alfresco 34d", null);
			createGeneratorConfiguration(conf, "com.bluexml.side.Form.generator.alfresco34d", null);
			...
			System.err.println("3.2R2 NOT YET IMPLEMENTED");
		}
	}
