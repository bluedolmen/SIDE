...
public class AssociationServices {
	...
	public static String getName(Association a, ClassModelElement e, boolean reverse) {
		...
		if (e instanceof Clazz) {
			...
			if (a.getFirstEnd().getLinkedClass() == c || a.getSecondEnd().getLinkedClass() == c) {
				...
				for (AbstractClass abClass : s) {
					if (a.getFirstEnd().getLinkedClass() == abClass || a.getSecondEnd().getLinkedClass() == abClass) {
						associationName = constructAssociationName(a, abClass, reverse);
					}
				}
			}
		}
	 ...
	 * @return
	 */
	public static String constructAssociationName(Association a, AbstractClass abClass, boolean reverse) {
		String associationName = "";

		associationName = abClass.getFullName().replace(".", "_") + "_" + a.getName();
		if (a.getSecondEnd().getLinkedClass() == abClass && !reverse) {
