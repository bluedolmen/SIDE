...
<%if (eContainer() == null) {%><%getProperty("alf.share.paths.web-ext.modules")%>documentlibrary/change-type.get_nl.properties<%}%>
...
## Labels
label.type=Nieuw type
label.select=Type selecteren...
