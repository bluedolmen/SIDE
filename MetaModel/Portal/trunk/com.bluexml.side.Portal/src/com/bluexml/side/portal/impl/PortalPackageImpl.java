...
public class PortalPackageImpl extends EPackageImpl implements PortalPackage {
	...
	public static PortalPackage init() {
		...
		PortalPackageImpl thePortalPackage = (PortalPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof PortalPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new PortalPackageImpl());
