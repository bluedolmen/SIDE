...
public class FormValidator extends EObjectValidator {
	 ...
	 * @generated
	 */
	private static Constraint field_validRefInvOCL;
	...
	public boolean validateField(Field field, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateField_validRef(field, diagnostics, context);
		return result;
	}
	...
	/**
	 * Validates the validRef constraint of '<em>Field</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateField_validRef(Field field, DiagnosticChain diagnostics, Map<Object, Object> context) {
        if (field_validRefInvOCL == null) {
			OCL.Helper helper = OCL_ENV.createOCLHelper();
			helper.setContext(FormPackage.Literals.FIELD);
			...
			try {
				field_validRefInvOCL = helper.createInvariant(expr);
			}
			catch (ParserException e) {
				throw new UnsupportedOperationException(e.getLocalizedMessage());
			}
		...
		Query<EClassifier, ?, ?> query = OCL_ENV.createQuery(field_validRefInvOCL);

		if (!query.check(field)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						((doThrowError( FormPackage.Literals.FIELD.getEAnnotation("http://www.eclipse.org/emf/2002/Ecore"),"validRef")? Diagnostic.ERROR : Diagnostic.WARNING),
						 DIAGNOSTIC_SOURCE,
						 0,
						 EcorePlugin.INSTANCE.getString("_UI_GenericConstraint_diagnostic", new Object[] { "validRef", getObjectLabel(field, context) }),
						 new Object[] { field }));
			}
			return false;
		}
	...
	public boolean validateBooleanField(BooleanField booleanField, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateField_validRef(booleanField, diagnostics, context);
		return result;
	}
	...
	public boolean validateCharField(CharField charField, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateField_validRef(charField, diagnostics, context);
	...
	public boolean validateDateField(DateField dateField, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateField_validRef(dateField, diagnostics, context);
		return result;
	}
	...
	public boolean validateDateTimeField(DateTimeField dateTimeField, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateField_validRef(dateTimeField, diagnostics, context);
		return result;
	}
	...
	public boolean validateDecimalField(DecimalField decimalField, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateField_validRef(decimalField, diagnostics, context);
		return result;
	}
	...
	public boolean validateFloatField(FloatField floatField, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateField_validRef(floatField, diagnostics, context);
		return result;
	}
	...
	public boolean validateIntegerField(IntegerField integerField, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateField_validRef(integerField, diagnostics, context);
		return result;
	}
	...
	public boolean validateEmailField(EmailField emailField, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateField_validRef(emailField, diagnostics, context);
	...
	public boolean validateFileField(FileField fileField, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateField_validRef(fileField, diagnostics, context);
		return result;
	}
	...
	public boolean validateImageField(ImageField imageField, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateField_validRef(imageField, diagnostics, context);
		return result;
	}
	...
	public boolean validateTimeField(TimeField timeField, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateField_validRef(timeField, diagnostics, context);
		return result;
	}
	...
	public boolean validateURLField(URLField urlField, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateField_validRef(urlField, diagnostics, context);
	...
	public boolean validatePhoneNumberField(PhoneNumberField phoneNumberField, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateField_validRef(phoneNumberField, diagnostics, context);
	...
	public boolean validateChoiceField(ChoiceField choiceField, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateField_validRef(choiceField, diagnostics, context);
		return result;
	}
	...
	public boolean validateRegexField(RegexField regexField, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateField_validRef(regexField, diagnostics, context);
	...
	public boolean validatePasswordField(PasswordField passwordField, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateField_validRef(passwordField, diagnostics, context);
	...
	public boolean validateVirtualField(VirtualField virtualField, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateField_validRef(virtualField, diagnostics, context);
	...
	public boolean validateActionField(ActionField actionField, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateField_validRef(actionField, diagnostics, context);
		return result;
	}
	...
	public boolean validateTextField(TextField textField, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateField_validRef(textField, diagnostics, context);
	...
	public boolean validateNumericalField(NumericalField numericalField, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateField_validRef(numericalField, diagnostics, context);
		return result;
	}
