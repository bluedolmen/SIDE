...
public class FormActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	...
	protected void addGlobalActions(IMenuManager menuManager) {
		...
		if (o != null) {
			...
			if (o instanceof ModelChoiceField) {
				...
				if (this.selectionProvider != null && this.selectionProvider.getSelection() != null && ((TreeSelection) this.selectionProvider.getSelection()).size() == 1 && ((TreeSelection) this.selectionProvider.getSelection()).getFirstElement() instanceof ModelChoiceField) {
				...
				if (this.selectionProvider != null && this.selectionProvider.getSelection() != null && ((TreeSelection) this.selectionProvider.getSelection()).size() == 1 && ((TreeSelection) this.selectionProvider.getSelection()).getFirstElement() instanceof Reference) {
			...
			if (((TreeSelection) this.selectionProvider.getSelection()).size() == 1 || haveSameFormContainer((TreeSelection) this.selectionProvider.getSelection())) {
			...
			if (o instanceof FormElement) {
				moveSiblingDown.setImageDescriptor(ImageDescriptor.createFromFile(this.getClass(), "/icons/menu/1downarrow_16x16.png"));
				menuManager.insertAfter("ui-actions", moveSiblingDown);
				moveSiblingUp.setImageDescriptor(ImageDescriptor.createFromFile(this.getClass(), "/icons/menu/1uparrow_16x16.png"));
				menuManager.insertAfter("ui-actions", moveSiblingUp);
	...
	/**
	 * Take a TreeSelection and return true if all have the same FormContainer
	 * as parent
	 * 
	 * @param selection
	 * @return
	...
	protected void fillExpandContextMenu(IMenuManager mgr) {
		...
		if (o instanceof ModelChoiceField && !(o instanceof Reference)) {
			...
			Set<AbstractClass> classes = ClassDiagramUtils.getDescendantClazzs(mcf.getReal_class());
	...
	protected void fillAddRefContextMenu(IMenuManager mgr) {
		...
		if (o instanceof Reference) {
			...
			Set<AbstractClass> classes = ClassDiagramUtils.getDescendantClazzs(ref.getReal_class());
			for (AbstractClass c : classes) {
