...
public interface AbstractView extends FieldContainer {
	 ...
	 *        annotation="http://www.bluexml.com/OCL description='Get all the fields of the AbstractView, excluding the FieldContainers' body='if (self.oclIsKindOf(AbstractDataTable)) then self.oclAsType(AbstractDataTable).getCols()->children->select(oclIsKindOf(Field))->asSet()->union(self.getDirectChildFields()).oclAsType(Field)  else self.getDirectChildFields().oclAsType(Field) endif'"
	 * @generated
	 */
	 ...
	 * <!-- end-user-doc -->
	 * @model kind="operation"
	 *        annotation="http://www.bluexml.com/OCL description='Get all the fields of the AbstractView, excluding the FieldContainers' body='self.children->select(oclIsKindOf(Field)).oclAsType(Field) ->asSet()'"
	 * @generated
	 */
