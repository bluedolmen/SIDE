...
public abstract class AbstractDataTableImpl extends DataTableElementImpl implements AbstractDataTable {
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == FieldContainer.class) {
			switch (derivedFeatureID) {
				case ViewPackage.ABSTRACT_DATA_TABLE__CHILDREN: return ViewPackage.FIELD_CONTAINER__CHILDREN;
				case ViewPackage.ABSTRACT_DATA_TABLE__DISABLED: return ViewPackage.FIELD_CONTAINER__DISABLED;
				default: return -1;
			}
		}
		...
		if (baseClass == AbstractViewOf.class) {
			switch (derivedFeatureID) {
				case ViewPackage.ABSTRACT_DATA_TABLE__VIEW_OF: return ViewPackage.ABSTRACT_VIEW_OF__VIEW_OF;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == FieldContainer.class) {
			switch (baseFeatureID) {
				case ViewPackage.FIELD_CONTAINER__CHILDREN: return ViewPackage.ABSTRACT_DATA_TABLE__CHILDREN;
				case ViewPackage.FIELD_CONTAINER__DISABLED: return ViewPackage.ABSTRACT_DATA_TABLE__DISABLED;
				default: return -1;
			}
		}
		if (baseClass == AbstractView.class) {
		...
		if (baseClass == AbstractViewOf.class) {
			switch (baseFeatureID) {
				case ViewPackage.ABSTRACT_VIEW_OF__VIEW_OF: return ViewPackage.ABSTRACT_DATA_TABLE__VIEW_OF;
				default: return -1;
			}
		}
