...
action_check_in=Archiver la copie de travail sous le nom ''{0}'' avec le commentaire ''{1}''
action_check_out=Extraire une copie de travail vers ''{0}''
...
add_to_list_button=Ajouter à la liste
...
admin_invalid_license=Licence : LICENCE INVALIDE - L'entrepôt Alfresco est restreint en lecture seulement.
admin_limited_license=Licence : {0} licence accordée à {1} et limitée à {3} jours expirant le {4,date,short} ({5} jours restant - générée le {2,date,short}).
admin_unlimited_license=Licence : {0} licence accordée à {1} et n''expire pas (générée le {2,date,short}).
...
apply_dashboard=Appliquer le modèle
apply_dashboard_doc_info=Choisir le modèle à appliquer à l'élément pour créer une vue personnalisée.
apply_dashboard_info=Choisir le modèle à appliquer à l'Espace pour créer une vue personnalisée.
apply_default_workflow=Appliquer le workflow par défaut
apply_rss_feed=Applquer le modèle de flux RSS
...
approve_step_name=Nom associé à l'étape d'approbation
aspect=Aspect
author=Auteur
...
cancel_workflow=Abandon du workflow
...
categories_description=Cette vue permet de parcourir et modifier la hiérarchie des catégories
category=Catégorie
...
check_in=Archiver
# Check-out messages
check_out=Extraire une copie de travail
check_out_of=Extraire une copie de travail de
checkin=Archiver la copie de travail
checkin_changes_info=Archiver les modifications et garder la copie de travail du fichier
...
checkout=Extraire une copie de travail
checkout_document=Extraire une copie de travail du document
checkout_file_title=Extraire une copie de travail
checkout_hint1=Astuce: extraire une copie de travail d'un document pour le verrouiller et empêcher d'autres utilisateur de l'éditer. Quand vous extrayez une copie de travail d'un document, vous travaillez avec une copie. Quand vous avez fini d'éditer la copie vous devez l'archiver pour libérer le verrou et permettre aux autres utilisateurs de visualiser les changements.
checkout_hint2=Lorsque vous avez fini d'éditer la copie de travail, vous devez l'archiver pour enlever le verrou et autoriser d'autres utilisateurs à travailler sur le document modifié.
...
checkout_warn=Note: les changements apportés à ce document seront perdus.
checkout_you_may_want=Vous pourriez extraire une copie de travail de ce fichier pour le verrouiller et empêcher d'autres utilisateurs de l'éditer.
checkoutfile_description=Entrez les informations sur la copie de travail.
checkoutfilelink_description=Editer le copie de travail du fichier ou annuler la copie de travail.
...
configure_dashboard_finish_instruction=Pour enregistrer la configuration du tableau de bord, cliquez sur 'Terminer'. Pour revoir ou modifier vos sélections, cliquez sur 'Précédent'.
configure_dashboard_step1_desc=Choisir la disposition et le nombre de colonnes pour votre tableau de bord.
configure_dashboard_step1_title=Etape un - Choisir la disposition
configure_dashboard_step2_desc=Choisir les composants pour votre tableau de bord et les ajouter aux colonnes.
configure_dashboard_step2_title=Etape deux - Choisir les composants
...
content_finish_instruction=Pour ajouter le contenu dans cet Espace, cliquez sur 'Terminer'. Pour revoir ou changer vos sélections cliquez sur 'Précédent'.
...
continue_working_info1=Si vous ne voulez pas éditer le fichier, cliquez sur OK pour fermer la page.
continue_working_info2=Pour éditer le fichier ultérieurement, cliquez sur 'Editer'
continue_working_title=Continuer à travailler
copied=copié
copy=Copier
copy_checkin_changes=Lorsque vous avez terminé vos modifications, vous devez archiver la copie de travail pour permettre aux autres utilisateurs de visualiser les modifications.
...
create_multilingual_space=Créer un Espace multilingue
create_multilingual_space_description=Entrez les informations sur le nouvel Espace, puis cliquez sur 'Créer un Espace'.
...
create_properties_close=Ajouter les propriétés lorsque cette page est fermée
create_reply=Répondre au message
...
create_rule_finish_instruction=Pour créer la règle, cliquez sur 'Terminer'. Pour revoir ou changer vos sélections, cliquez sur 'Précédent'.
...
create_space_finish_instruction=Pour clôre cet assistant et créer votre Espace, cliquez sur 'Terminer'. Pour revoir ou changer vos sélections, cliquez sur 'Précédent'.
...
create_website_finish_instruction=Pour terminer ce wizard et créer votre Espace de projet web, cliquez sur 'Terminer'. Pour revoir ou modifier vos sélections, cliquez sur 'Précédent'.
...
create_website_step3_desc=Sélectionnez et configurez le workflow pour les éléments créés en dehors des formulaires web.
create_website_step3_title=Etape trois - Configurer le workflow
create_website_step4_desc=Sélectionnez les utilisateurs et leurs rôles.
create_website_step4_title=Etape quatre - Ajouter des utilisateurs
create_website_step5_desc=Notifiez les utilisateurs invités
create_website_step5_title=Etape cinq - Envoyer un courriel aux utilisateurs
create_website_summary_users=Utilisateurs et röles
...
creation=Création
creator=Créateur
current_repo=Entrepôt Alfresco courrant
...
dashboard_view=Visualisation du tableau de bord
dashlet_btn_remove=Supprimer
...
delete_avm_file_confirm=Etes-vous sûr de vouloir supprimer \"{0}\" du bac à sable ?
delete_avm_file_info=Pour supprimer ce fichier du bac à sable, cliquez sur OK.
delete_avm_folder_confirm=Etes-vous sûr de vouloir supprimer \"{0}\" et son contenu du bac à sable ?
...
delete_category_confirm=Etes-vous sûr de vouloir supprimer la catégorie \"{0}\" et toutes ses sous-catégories ?
delete_category_info=Pour supprimer cette catégorie et toutes ses sous-catégories, cliquez sur 'Supprimer'.
delete_category_warning={0} documents sont inclus dans cette categorie.
delete_companyroot_confirm=ATTENTION : Ce dossier est un dossier spécial accédé par tous les utilisateurs ! Veuillez vous assurer que vous souhaitez supprimer ce dossier. Sa suppression peut entraîner des erreurs système.
delete_file=Supprimer le fichier
delete_file_confirm=Etes-vous sûre de vouloir supprimer \"{0}\" et tous ses versions précédentes?
...
delete_forum_confirm=Etes-vous sûr de vouloir supprimer \"{0}\", et toutes ses discussions ?
...
delete_group_confirm=Dès que le groupe est effacé du système, il ne sera plus accessible. Etes-vous sûr que vous voulez supprimer le groupe \"{0}\" et détruire tous ses utilisateurs ?
...
delete_item_success=L''élément \"{0}\" a été définitivement effacé.
delete_listed_items=Supprimer les Eléments Sélectionnés
delete_listed_items_confirm=Etes-vous sûr que vous voulez supprimer définitivement les fichiers et Espaces suivants du dossier des éléments effacés ? Les éléments ne pourront plus être récupérés lorsque cette action aura été réalisée.
...
delete_rule_confirm=Etes-vous sûr de vouloir supprimer \"{0}\" ?
delete_rule_info=Pour supprimer cette règle de l'Espace, cliquez sur OK.
delete_sandbox=Supprimer le bac à sable
delete_sandbox_confirm=Etes-vous sûr de vouloir supprimer le bac à sable utilisateur \"{0}\" du projet web ?
...
delete_space_confirm=Etes-vous sûr de vouloir supprimer \"{0}\" et tout son contenu ?
delete_space_info=Pour supprimer cet Espace et tout son contenu, cliquez sur OK.
delete_topic=Supprimer une Discussion
...
delete_user_confirm=L''utilisateur n''aura plus la possibilité d''accéder au système. Etes-vous sûre de vouloir supprimer l''utilisateur \"{0}\" ?
delete_user_info=Pour supprimer cet utilisateur du système, cliquez sur 'Oui'.
delete_website=Supprimer le projet web
delete_website_confirm=Etes-vous sûr de vouloir supprimer ce projet web \"{0}\" et tous ses bacs à sable ?
...
deploy_desc=Sélectionner les serveurs cibles du déploiement et cliquez sur OK.
...
deploy_server_not_selected=Ce serveur n'a pas été sélectionné car l'image (snapshot) a déjà été déployée avec succès.
deploy_started=Démarré
deploy_status=L''image (snapshot) {0} est en train d''être déployée en arrière-plan, rafraîchir la page jusqu''à ce que le lien "Voir le rapport de déploiement" apparaisse.
deploy_status_failed=Echec
deploy_status_in_progress=En cours
deploy_status_live=Déployé
deploy_status_partial=Erreur partielle
deploy_successful=Déploiement réussi
deploy_title=Déployer l'image (snapshot)
deploy_to_help=Une liste de serveurs sur lesquels le site web est à déployer, séparés par une virgule. <p>Chaque entrée peut être un nom ou une adresse IP, muni éventuellement d''un numéro de port RMI. Si ce dernier n''est pas spécifié, le numéro par défaut {0} sera utilisé.</p> <p>Exemple : serveur1, serveur2:50900</p>
deployed_by=Par
...
deployment_report_title_for=Voir le rapport de déploiement pour l''image (snapshot) {0}
...
doc_part_of_advanced_workflows=Ce document fait partie des workflows avancés suivants
...
edit_file_prompt=Pour éditer le fichier ''{0}'', cliquez sur le lien ci-dessous. Selon votre navigateur, vous pouvez effectuer un clic droit sur le lien et sélectionner Enregistrer la cible sous.
...
edit_rule_finish_instruction=Pour mettre à jour la règle, cliquez sur 'Terminer'. Pour revoir ou changer vos sélections, cliquez sur 'Précédent'.
...
edit_website_finish_instruction=Pour fermer cet assistant et sauvegarder les paramètres modifiés de votre Espace de projet web, cliquez sur 'Terminer'. Pour revoir ou modifier vos sélections, cliquez sur 'Précédent'.
...
error_actions=Impossible d''exécuter les Actions à cause de l''erreur : {0}
error_aspect_classify=Impossible d''appliquer l''aspect ''catégorisable'' au document à cause de l''erreur système : {0}
error_aspect_classify_space=Echec d''application de l''aspect ''catégorisable'' à l''Espace à cause d''une erreur système : {0}
error_aspect_inlineeditable=Impossible d''appliquer l''aspect ''éditable en ligne'' au document à cause de l''erreur système : {0}
error_aspect_versioning=Impossible d''appliquer l''aspect ''versionnable'' au document à cause de l''erreur système : {0}
...
error_checkout=Impossible d'extraire une copie de travail du contenu suite à une erreur système :
...
error_delete_file=Impossible de supprimer le fichier suite à une erreur système :
...
error_delete_sandbox=Impossible de supprimer le bac à sable suite à une erreur système :
error_delete_space=Impossible de supprimer l''Espace suite à une erreur système :
error_delete_user=Impossible de supprimer l''utilisateur suite à l''erreur : {0}
error_delete_user_object=Impossible de supprimer l'utilisateur associé cette personne. Ce n'est pas une erreur si une authentification externe comme NTLM était activée auparavant.
error_deleted_folder=L''Espace référencé par l''Id : {0} - a été supprimé de la base de données. Le système a modifié l''emplacement de votre Espace courant car l''Espace où vous étiez n''existe plus.
error_dialog=Veuillez corriger les erreurs ci-dessous puis cliquez sur OK.
error_exists=Un Espace ou un Fichier existe déjà avec le nom : {0}
error_export=Impossible d''exécuter l''export : {0}
error_export_all=Veuillez corriger les erreurs d'export ci-dessous, puis cliquez sur OK.
error_filename_pattern=Erreur dans le motif de nom de fichier du workflow : {0}
# UI Error messages
error_generic=Une erreur système s''est produite pendant l''opération : {0}
error_homespace=L''Espace d''acccueil référencé par l''Id : {0} ne peut pas être trouvé. Il se peut qu''il ait été supprimé de la base de données. Veuillez contacter votre administrateur système.
error_import=Impossible d''exécuter l''import : {0}
error_import_all=Veuillez corriger les erreurs d'import ci-dessous, puis cliquez sur OK.
error_import_empty_file=Impossible d'importer un paquetage Alfresco vide !
error_import_no_file=Impossible de trouver un paquetage Alfresco à importer !
...
error_noderef=Impossible de trouver l''élément de l''entrepôt référencé par l''Id : {0} - l''enregistrement a probablement été supprimé de la base de données.
...
error_person=Echec de création de l''utilisateur suite à l''erreur : {0}
...
error_remove_user=Impossible de retirer l''utilisateur suite à cause de l''erreur : {0}
error_restore_search=Impossible de restaurer la recherche sauvegardé suite à l''erreur : {0}
error_rule=Echec de création de la règle suite à l''erreur : {0}
error_save_search=Impossible d''enregistrer la recherche suite à l''erreur : {0}
error_search=La recherche a échoué suite à une erreur système : {0}
error_shortcut_permissions=Impossible de joindre cet élément car il ne peut pas être lu par cet utilisateur. Un autre utilisateur a peut-être modifié ses permissions.
error_space=Echec de création du nouveau Espace suite à l''erreur : {0}
error_update=Impossible de mettre à jour le contenu suite à une erreur système :
error_update_category=Impossible de mettre à jour la catégorie suite à l''erreur système : {0}
error_update_simpleworkflow=Impossible de mettre à jour le workflow simple suite à l''erreur système : {0}
error_wizard=Veuillez corriger les erreurs ci-dessous puis cliquez sur Terminer.
error_workflow_approve=Impossible d''approuver le document à cause de l''erreur système : {0}
error_workflow_reject=Impossible de rejeter le document suite à l''erreur système : {0}
existing_space=Espace existant
export=Exporter
export_error_info=Si cette option est sélectionnée, l'export sera exécuté en tâche de fond, donc son résultat peut ne pas apparaître immédiatement. Pour le suivre, vous pouvez consulter la console du serveur ou rechercher des erreurs dans les journaux d'évènement.
export_from=Exporter à partir de
# Export messages
export_info=Exporter les méta-données et les contenus de cet ou de tous les Espaces.
failed_gen_url=Echec dans la génération de l''url pour le moteur de recherche ''{0}''.\\n\\nCeci est probablement dû à des paramètres requis manquants ; vérifier le modèle d''url associé au moteur de recherche.
failed_search=Echec dans l''obtention des résultats de recherche de ''{0}''
...
form_template_details_desc=Editer les détails de ce formulaire web
form_template_select_templates=Configurer les Modèles
form_template_templates=Configurer les Modèles
form_template_templates_desc=Configurer les Modèles que vous voulez utiliser pour le formulaire web.
...
gettingstarted_addcontent_desc=Allez à votre Espace d'accueil. Dans la zone d'information de l'Espace, cliquez sur 'Ajouter un contenu' et entrez les informations sur le contenu à importer.
...
gettingstarted_createcontent_desc=Allez à votre Espace d'accueil. Dans la zone d'information de l'Espace, dans le menu 'Créer', cliquez sur 'Créer un contenu' et entrez les informations sur le contenu à créer.
gettingstarted_createspace=Créer un Espace dans votre Espace d'accueil
gettingstarted_createspace_desc=Allez à votre Espace d'accueil. Dans la zone d'information de l'Espace, dans le menu 'Créer', cliquez sur 'Créer un Espace' et entrez les informations sur l'Espace à créer.
...
groups_err_group_name=L''ID de groupe ne peut pas contenir les caractères : {0}
...
import_error_info=Si cette option est sélectionnée, l'import sera exécuté en tâche de fond, donc son résultat peut ne pas apparaître immédiatement. Pour le suivre, vous pouvez consulter la console du serveur ou rechercher des erreurs dans les journaux d'évènement.
# Import messages
import_info=Importe un paquetage de contenu Alfresco ou un fichier ZIP dans l'entrepôt.
import_package_description=Paquetage de contenu Alfresco
...
include_inherited_rules=Prendre en compte les règles héritées
...
invite_finish_instruction=Cliquer sur Terminer pour fermer cet assistant et appliquer vos modifications. Pour revoir vos sélections, cliquez sur Précédent.
invite_role=Vous aurez le rôle de : {0}
...
invite_website_users=Inviter des utilisateurs
invite_webusers_desc=Inviter de nouveaux utilisateurs et créer les bacs à sable pour le projet web.
invite_webusers_finish_instruction=Pour terminer cet assistant et créer l'utilisateur de test, cliquez sur Terminer. Pour revoir et modifier vos sélections, cliquez sur Précédent.
invite_webusers_step1_desc=Sélectionnez les utilisateurs et leurs rôles.
invite_webusers_step1_title=Etape un - Inviter les utilisateurs
...
link_to=Lier à
link_validaton_report_title=Rapport de vérification des liens
link_validaton_report_desc=Cet assistant permet de voir le résultat de la validation des liens, et permet de corriger les liens brisés.
...
location=Emplacement de l'élément
lock=Verrouillage
...
login_err_password_length=La longueur du mot de passe doit être comprise entre 5 et 12 caractères.
login_err_username_chars=Seuls les caractères et les chiffres sont autorisés dans le nom d'utilisateur.
login_err_username_length=La longueur du nom d'utilisateur doit être comprise entre 5 et 12 caractères.
logout=Déconnexion
look_for=Rechercher
...
monitor_deployment_desc=Surveille la progression du déploiement d'une image (snapshot) sur un ou plusieurs serveurs.
monitor_deployment_title=Surveiller le déploiement
more_actions=Actions supplémentaires
more_options=Davantage...
more_options_file=Actions supplémentaires pour ce document
more_options_space=Actions supplémentaires pour cet Espace
move=Déplacer
move_or_copy=Choisir si vous souhaitez déplacer ou dupliquer le contenu ainsi que l'emplacement.
moved=déplacé
my_alfresco=Mon Tableau De Bord
...
new_user_finish_instruction=Cliquez sur 'Terminer' pour créer le nouvel utilisateur. Cliquez sur 'Précédent' pour revoir ou modifier vos choix.
...
no_content_items=Aucun élément à afficher. Pour ajouter un document existant, cliquez sur ''{0}''. Pour créer un fichier Texte ou HTML, cliquez sur ''{1}''.
...
no_forums=Aucun forum ou Espace forum à afficher. Cliquer sur 'Créer un Espace forum' pour créer un Espace forum ou sur 'Créer un forum' pour créer un forum.
...
no_posts=Aucun message à afficher. Cliquer sur 'Créer une message' pour créer un message.
...
no_space_items=Aucun élément à afficher. Cliquer sur ''{0}'' pour créer un Espace.
no_tasks=Aucune tâche trouvée.
no_topics=Aucune discussion à afficher. Cliquer sur 'Créer une discussion' pour créer une discussion.
node_added_clipboard=Un élément a été ajouté au presse-papiers. Il y a actuellement {0} élément(s) dans le presse-papiers. Pour coller tous les éléments collectés, se placer dans l''Espace désiré puis dans le menu ''Actions Supplémentaires'' sélectionner ''Tout coller''.
...
not_in_workflow=Ce document ne fait partie d'aucun workflow.
...
post=Publier
post_reply=Répondre
post_to_topic=Ecrire sur la discussion
posted=Publié
...
properties_close=Editer les propriétés multilingues lorsque cette page est fermée.
raise_issue=Remonter un incident
...
recent_snapshots=Historique des modifications
recent_spaces=Espaces récents
recover=Récupérer
recover_all_items=Récupérer tous les éléments
recover_all_items_confirm=Etes-vous sûr que vous voulez récupérer tous les fichiers et Espaces du dossier des éléments effacés ?
recover_all_items_info=Récupère tous les fichiers et Espaces du dossier des éléments effacés
recover_item=Récupère un Elément
recover_item_confirm=Etes-vous sûr que vous voulez récupérer \"{0}\" du dossier des éléments effacés ?
...
recovered_item_failure=Echec de récupération de l''élément \"{0}\" à cause de l''erreur : {1}
...
recovered_item_permission=Impossible de récupérer l''élément \"{0}\" car vous n''avez pas les permissions adéquates pour restaurer l''élément dans le répertoire parent, veuillez sélectionner un nouveau répertoire de destination.
recovered_item_permission_short=Pas de permission d'écriture
recovered_item_success=L''élément \"{0}\" a été récupéré avec succès.
...
reject_step_name=Nom associé à l'étape de refus
relogin=Re-connexion à Alfresco
remove=Retirer
remove_all=Tout enlever
remove_content_user_confirm=L''utilisateur n''aura plus la possibilité d''accéder à ce contenu. Etes-vous sûr de vouloir supprimer l''utilisateur \"{0}\" ?
remove_content_user_info=Pour retirer un utilisateur de ce contenu, cliquer sur 'Oui'.
remove_invited_user_confirm=L''utilisateur n''aura plus la possibilité d''accéder aux documents et dossiers dans cet Espace. Etes-vous sûr de vouloir supprimer l''utilisateur \"{0}\" ?
...
revert_all_confirm=Etes-vous sûr d'annuler les modifications des fichiers dans le bac à sable ?
...
revert_sandbox_success=Succès du retour arrière du bac à sable ''{0}'' en version : {1}
...
revert_success=Succès du retour arrière de l''élément : {0}
revertall_success=Succès du retour arrière du bac à sable de l''utilisateur : {0}
revertselected_success=Succès du retour arrière des éléments de l''utilisateur : {0}
role=Rôle
roles=Rôles
...
run_action_finish_instruction=Pour exécuter une action, cliquez sur 'Terminer'. Pour revoir ou changer vos sélections, cliquez sur 'Précédent'.
...
run_link_validaton_title=Lancer la validation des liens
run_link_validaton_desc=Cette page montre l'état d'avancement de la validation des liens actuellement en cours.
sandbox_browse=Parcourir l'arborescence du site
...
sandbox_remove=Supprimer le bac à sable
...
sandbox_snapshot=Créer un aperçu
sandbox_snapshot_info=Créer un aperçu de ce bac à sable
...
save_search_description=Enregistrer une requète de recherche pour un usage ultérieur
...
search_detail=Recherche pour \"{0}\", resultats affichés ci-dessous
search_in=Rechercher dans
search_minimum=Des informations inssufisantes ont été entrées pour lancer une recherche, au moins une valeur ou une localisation doivent être entrés pour la recherche. Les champs Texte requièrent un minimum de {0} caractères.
...
select_layout=Sélectionnez le style de disposition pour votre tableau de bord.
...
set_and_add_button=Définir les paramètres et ajouter
...
snapshot_failure=Image non crée - Le bac à sable n'a pas été modifié depuis le dernier aperçu.
snapshot_label=Label
snapshot_preview=Aperçu
snapshot_properties=Propriétés de l'image
snapshot_revert=Retour Arrière
snapshot_success=Image ''{0}'' crée pour le bac à sable : {1}
source=Origine
space=Espace
space_action=Cet Espace sera {0} en ''{1}'' si l''action ''{2}'' est exécutée.
space_copy_note=Note: toutes les règles de contenu appliquées à cet Espace seront également copiées.
...
space_type_note=Note: Si vous ne voyez qu'un seul type d'Espace alors les autres ne sont peut être pas activés.
...
start_workflow_finish_instruction=Pour démarrer le workflow, cliquez sur Terminer. Pour revoir ou modifier vos sélections, cliquez sur Précédent.
start_workflow_no_metadata=Il n'y a aucun métadata à collecter pour ce workflow particulier.
...
submit_success=L''élément {0} a été soumis avec succès
...
submitall_success=Le bac à sable de l''utilisateur {0} a été soumis avec succès
submitselected_success=Les éléments sélectionnés de l''utilisateur {0} ont été soumis avec succès
...
title=Titre
# UI Page Titles
title_about=A propos d'Alfresco
title_action_add_feature=Action d'ajout de fonctionnalité
title_action_checkin=Action d'archivage
title_action_checkout=Action d'extraction
...
title_add_content=Ajout de contenu
...
title_browse=Alfresco client web
...
title_checkin_file=Archiver la copie de travail du fichier
title_checkout_file=Extraire une copie de travail d'un fichier
...
title_content_users=Gérer les utilisateurs de contenu
...
title_error=Alfresco client web - Erreur Système
title_export=Export
...
title_invitecontentusers_invite=Inviter les utilisateurs de contenu - Inviter
title_invitecontentusers_notify=Inviter les utilisateurs de contenu - Notifier
title_invited_users=Gestion des utilisateurs invités
title_inviteusers_invite=Inviter des utilisateurs - Inviter
title_inviteusers_notify=Inviter des utilisateurs - Notifier
title_login=Alfresco client web - Connexion
title_missing_working_copy=La copie de travail n'est plus accessible
title_my_alfresco=Mon Tableau De Bord
...
title_recover_all=Récupère tous les éléments
title_recover_item=Récupère un élément
title_recover_listed=Récupère les éléments sélectionnés
title_recovery_report=Rapport de récupération
title_relogin=Alfresco client web - Déconnecté
title_remove_invited_user=Supprimer des utilisateurs invités
title_rules=Règles d'un Espace
title_save_search=Enregistrer la recherche
title_space_details=Détails d'un Espace
...
title_user_console=Options de l'utilisateur
...
user_console=Options utilisateur
...
user_err_user_name=L''ID utilisateur ne peut pas contenir les caractères : {0}
...
user_search_info=Pour trouver un utilisateur, le chercher en utilisant son nom, son prénom ou son nom d'utilisateur. Egalement, pour voir tous les utilisateurs, cliquer 'Voir Tous', cependant, cette action pourra prendre un certain temps s'il y a beaucoup d'utilisateurs sur le système.
...
validation_invalid_dns_name=Nom DNS du site web invalide, il doit contenu au minimum deux caractères alpha-numériques.
validation_is_number={0} doit contenir un nombre.
validation_mandatory={0} est un champs nécessaire.
validation_numeric_range={0} doit être entre {1} et {2}.
validation_provide_values_for_required_fields=Prière de fournir des valeurs pour tous lees champs obligatoires
...
which_copy_checkin=Quelle copie souhaitez-vous archiver ?
...
workflow_command_submit=Envoyer
...
working_copy_missing_info=Cette copie de travail n'est plus disponible. Cela peut être dû à une ou des règles actives sur l'Espace dans lequel vous avez extrait une copie de travail.
...
broken_items_fixed={0} élément(s) incorrect(s) ont été corrigé(s).
broken_links=Liens brisés
broken_links_fixed={0} lien(s) brisé(s) ont été corrigé(s).
change_expiration_date_change=Pour changer la date d'expiration fichier par fichier cliquez sur l'icône de changement de date d'expiration.
...
check_links_info=Si des liens brisés sont trouvés, vous recevrez une notification dans votre liste de tâches à réaliser.
checking_links_progress=Vérification des liens en cours, veuillez patienter ...
checking_links_status=Vérification de <span id='link-count'>0</span> liens dans <span id='file-count'>0</span> fichiers.
click_to_edit=Cliquer pour éditer
comment=Commentaire
content_launch=Publication planifiée
...
expiration_date=Date d'expiration du contenu
expiration_date_header=Date de retrait
expire_date_label=Expire
expired_content_for_review=Contenu expiré pour relecture
files_links_broken={0} lien(s) brisé(s) ont été trouvé(s) dans {1} fichier(s).
files_links_checked=La vérification a été faite le {0}, {1} fichier(s) ont été vérifié(s) et {2} lien(s) ont été trouvés.
files_links_checked_error=La vérification a échoué à {0} à cause de l''erreur :
files_links_still_broken={0} lien(s) sont toujours incorrects dans {1} fichier(s).
files_with_broken_links=Fichiers statiques avec des liens brisés
fixed_items=Eléments que vous avez corrigé
forms_with_broken_links=Fichiers générés avec des liens brisés
...
initial_check=Vérification initiale
launch_date=Date de publication
link_validation=Validation des liens
link_validation_error=Une erreur est survenur durant la vérification des liens
link_validation_unknown_error=Une erreur inconnue est survenue durant la vérification des liens
link_validaton_dialog_desc=Cet assistant montre le résultat de la vérification des liens et permet aux liens d'être réparés.
link_validaton_dialog_title=Rapport de Validation des Liens
locale=Locale
...
manage_multilingual_details_description=Utilise cette page pour gérer le contenu multilingue.
...
new_edition_choose_translation_desc=Choisir le contenu du contenu dont vous voulez créer une nouvelle édition.
...
new_edition_details_title=Etape deux - Détail de l'édition
new_edition_finish_instruction=Pour terminer cet assistant et appliquer vos modifications, cliquez sur 'Terminer'.
new_edition_from=Nouvelle édition de ce
new_edition_summary_desc=L'information que vous avez entrée est affichée ci-dessous.
new_edition_summary_title=Etape trois - Résumé
...
new_edition_wizard_title=Assistant de nouvelle édition
...
regenerate_renditions_summary_desc={0} {0,choisir,0#rendus|1#rendu|1<rendus} ont été regénérés dans le projet web {1}.
...
rerun_report=Relancer le test
select=Sélectionner
select_language=<Sélectionner la langue>
set_expiration_date=Choisir la date d'expiration pour tous les éléments modifiés.
...
step2_edition_details=Détail des éditions
...
tasks_active_desc=Liste des tâches actives pour finaliser
tasks_active_title=Toutes les tâches actives
trad_exists_error=Une traduction existe déjà pour cette locale.
...
view_link_validation_report=Voir le rapport de validation des liens
web_project=Projet web
workflow_history=Historique du workflow

##################
# End of your user code here. <%endUserCode%>
##################

<%for (getAllClasses()){%>
<%getLabel()%>
# Messages for <%getQualifiedName()%>
<%getQualifiedName()%>_title=<%getLabel()%>
<%--
<%getQualifiedName()%>_search_title=Search form for <%getLabel()%>
--%>
<%getQualifiedName()%>_creation=Création d'un(e) <%getLabel()%>
<%getQualifiedName()%>_creation_finish=Création effectuée.
<%getQualifiedName()%>_creation_canceled=Création abandonnée.
<%getQualifiedName()%>_modification_finish=Modification effectuée - Cliquer sur Fermer pour revenir à la liste des <%getLabel()%>
<%getQualifiedName()%>_modification_canceled=Modification abandonnée - Cliquer sur Fermer pour revenir à la liste des <%getLabel()%>
<%getQualifiedName()%>_modification=Modification d'un(e) <%getLabel()%>
<%getQualifiedName()%>_modification_description=Formulaire de modification d'un(e) <%getLabel()%>
<%getQualifiedName()%>_description=Formulaire d'ajout d'un(e) <%getLabel()%>
<%getQualifiedName()%>_instruction=Modifier la valeur des champs et valider
<%--
<%getQualifiedName()%>_search_creation=<%getLabel()%> : recherche
<%getQualifiedName()%>_search_description=Formulaire de recherche
<%getQualifiedName()%>_search_instruction=Modifier la valeur des champs. Pour une recherche direct cliquez sur Rechercher, pour sauvegarder votre recherche cliquez sur Terminer.
--%>
<%for (attributes){%>
<%getQualifiedName()%>_title=<%getLabel()%>
<%getQualifiedName()%>_description=<%getDescriptionOrName()%>
<%}%>
<%for (associations){%>
<%current(1).getQualifiedName()%>_<%name%>_title=<%getLabel()%>
<%}%>
<%}%>
...
<%for (getAllClasses()){%>
<%getLabel()%>
# Messages for dashlet <%getQualifiedName()%>
dashlet_<%getQualifiedName()%>_recent_label=Mes dernier(e)s <%getLabel()%>
dashlet_<%getQualifiedName()%>_recent_desc=Récupération de mes dernier(e)s <%getLabel()%>
<%}%>
<%for (getAllClasses()){%>
# Messages for dashlet <%getQualifiedName()%>
dashlet_<%getQualifiedName()%>_recent_DHX_label=Mes dernier(e)s <%getLabel()%> (dhx)
dashlet_<%getQualifiedName()%>_recent_DHX_desc=Récupération de mes dernier(e)s <%getLabel()%> (dhx)
<%}%>
##################
...
<%for (getAllClasses()){%>
create_<%getQualifiedName()%>=Créer un(e) <%getLabel()%>
<%getQualifiedName()%>_please_select_one=Veuiller sélectionner un(e) <%getLabel()%>
<%}%>
create_Litteral=Créer un(e) Enumeration value
Litteral_please_select_one=Veuiller sélectionner un(e) Enumeration value
create_EnumerationType=Créer un(e) Enumeration Type
EnumerationType_please_select_one=Veuiller sélectionner un(e) Enumeration Type
create_LitteralTranslation=Créer un(e) Translation
LitteralTranslation_please_select_one=Veuiller sélectionner un(e) Translation
create_VisibilityContext=Créer un(e) Visibility Context
VisibilityContext_please_select_one=Veuiller sélectionner un(e) Visibility Context


##################
# message to describe regExp contraints
##################
<%for (getAllClasses()){%>
<%for (getAllAttributes()){%>
	<%if (metainfo[key.equalsIgnoreCase("regular-expression-desc")].nSize()>0){%>
<%current("MMUseCase.Attribute").getQualifiedName()%>_regexp_desc=<%metainfo[key.equalsIgnoreCase("regular-expression-desc")].value%>
	<%}%>
<%}%>
...
# Global messages
##################
BXDS_error=Erreur du Portail - Merci de contacter votre administrateur si le problème persiste.
treeViewOf=Arbre des 