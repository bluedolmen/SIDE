...
<%getFolder()%>_<%current(1).name%>model.type.<%getFolder()%>_<%getQualifiedName()%>.description=<%getDescription()%>
	<%for (attributes){%>
<%getFolder()%>_<%current(2).name%>model.property.<%getFolder()%>_<%current(1).getQualifiedName()%>_<%name%>.title=<%getLabel()%>
<%getFolder()%>_<%current(2).name%>model.property.<%getFolder()%>_<%current(1).getQualifiedName()%>_<%name%>.description=<%getDescription()%>
	<%}%>
...
<%getFolder()%>_<%current(2).name%>model.association.<%getFolder()%>_<%current(1).getQualifiedName()%>_<%name%>.description=<%getDescription()%>
	<%}%>	
...
<%getFolder()%>_<%current(1).name%>model.aspect.<%getFolder()%>_<%getQualifiedName()%>.description=<%getDescription()%>
	<%for (attributes){%>
<%getFolder()%>_<%current(2).name%>model.property.<%getFolder()%>_<%current(1).getQualifiedName()%>_<%name%>.title=<%getLabel()%>
<%getFolder()%>_<%current(2).name%>model.property.<%getFolder()%>_<%current(1).getQualifiedName()%>_<%name%>.description=<%getDescription()%>
	<%}%>
