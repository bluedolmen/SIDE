...
public class CdDiagramTopcasedPreferenceInitializer implements ITopcasedPreferenceInitializer {
	...
	public HashMap<String, String> getDefaultPreference() {
		...
		defaultCdPreference.put(CdDiagramPreferenceConstants.COMMENT_DEFAULT_BACKGROUND_COLOR, "191,249,217");

		// Initialize the default value of the COMMENT_DEFAULT_FOREGROUND_COLOR property
		defaultCdPreference.put(CdDiagramPreferenceConstants.COMMENT_DEFAULT_FOREGROUND_COLOR, "0,0,0");

		// Initialize the default value of the COMMENT_DEFAULT_FONT property
		defaultCdPreference.put(CdDiagramPreferenceConstants.COMMENT_DEFAULT_FONT, StringConverter.asFontData("Lucida Grande-regular-11").toString());
