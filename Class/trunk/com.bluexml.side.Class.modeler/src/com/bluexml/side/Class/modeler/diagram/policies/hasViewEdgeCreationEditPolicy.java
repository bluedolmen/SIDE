...
import com.bluexml.side.Class.modeler.diagram.commands.hasViewEdgeCreationCommand;

/**
 * hasView edge creation
 *
 * @generated
 */
public class hasViewEdgeCreationEditPolicy extends
	...
	protected boolean checkCommand(Command command) {
		return command instanceof hasViewEdgeCreationCommand;
	}
