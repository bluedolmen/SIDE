...
public class EnumerationLiteralDataStructure
{
    ...
    public class EnumerationLiteralObject
    {
         ...
         */
        public EnumerationLiteralObject(String n)
        {
            name = n;
        }
    ...
    {
        data.add(new EnumerationLiteralObject(literal.getName()));
    }
    ...
    {
        data.add(new EnumerationLiteralObject(name));
    }
    ...
    public void addAll(Collection parameters)
    {
        ...
        {
            EnumerationLiteral parameter = (EnumerationLiteral) itParameters.next();
            add(parameter);
        }
    }
	...
	public void replace(int index_first, int index_last) {
		Object object_first = data.get(index_first);
		Object object_last = data.get(index_last);
