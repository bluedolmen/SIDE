...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cmis="http://www.cmis.org/2008/05" xmlns:alf="http://www.alfresco.com" version="2.0">
	...
	<xsl:template match="entry">
		...
		<resource title="{child::title[1]}" href="{concat($ref_alfresco,'+',$ref_share)}">
           <map heading="{child::cmis:object/cmis:properties/cmis:propertyString[@cmis:name='com.bluexml.demo.rh.ContratDeTravail.type']/cmis:value}"/>
           <map heading="{child::cmis:object/cmis:properties/cmis:propertyString[@cmis:name='com.bluexml.demo.rh.ContratDeTravail.dateDembauche']/cmis:value}"/>
           <map heading="{child::cmis:object/cmis:properties/cmis:propertyString[@cmis:name='com.bluexml.demo.rh.ContratDeTravail.statut']/cmis:value}"/>
