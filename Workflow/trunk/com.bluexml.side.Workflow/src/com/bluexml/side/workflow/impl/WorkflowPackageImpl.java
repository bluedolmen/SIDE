...
public class WorkflowPackageImpl extends EPackageImpl implements WorkflowPackage {
	 ...
	 * @generated
	 */
	public EReference getSwimlane_Assignment() {
	 ...
	 * @generated
	 */
	public EReference getTaskNode_Task() {
	 ...
	 * @generated
	 */
	public EAttribute getDecision_Transitioncondition() {
	 ...
	 * @generated
	 */
	public EReference getAction_ParentEvent() {
	 ...
	 * @generated
	 */
	public EReference getAction_ParentTimer() {
	 ...
	 * @generated
	 */
	public EReference getTask_Swimlane() {
	 ...
	 * @generated
	 */
	public EReference getTask_Event() {
	 ...
	 * @generated
	 */
	public EReference getTask_Timer() {
	 ...
	 * @generated
	 */
	public EReference getTimer_Action() {
	 ...
	 * @generated
	 */
	public EAttribute getAssignment_Actorid() {
	 ...
	 * @generated
	 */
	public EAttribute getAssignment_Pooledactors() {
	 ...
	 * @generated
	 */
	public EAttribute getAssignment_Clazz() {
	...
	public void createPackageContents() {
		...
		createEReference(swimlaneEClass, SWIMLANE__ASSIGNMENT);
		...
		createEReference(taskNodeEClass, TASK_NODE__TASK);
		...
		createEAttribute(decisionEClass, DECISION__TRANSITIONCONDITION);
		...
		createEReference(actionEClass, ACTION__PARENT_EVENT);
		createEReference(actionEClass, ACTION__PARENT_TIMER);
		...
		createEReference(taskEClass, TASK__SWIMLANE);
		createEReference(taskEClass, TASK__ASSIGNMENT);
		createEReference(taskEClass, TASK__EVENT);
		createEReference(taskEClass, TASK__TIMER);

		timerEClass = createEClass(TIMER);
		createEAttribute(timerEClass, TIMER__NAME);
		createEAttribute(timerEClass, TIMER__DUEDATE);
		createEReference(timerEClass, TIMER__ACTION);

		assignmentEClass = createEClass(ASSIGNMENT);
		createEAttribute(assignmentEClass, ASSIGNMENT__ACTORID);
		createEAttribute(assignmentEClass, ASSIGNMENT__POOLEDACTORS);
		createEAttribute(assignmentEClass, ASSIGNMENT__CLAZZ);
	...
	public void initializePackageContents() {
		...
		initEReference(getSwimlane_Assignment(), this.getAssignment(), null, "assignment", null, 1, 1, Swimlane.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getSwimlane_Manage(), this.getTask(), this.getTask_Swimlane(), "manage", null, 0, -1, Swimlane.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getNode_Action(), this.getAction(), null, "action", null, 1, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getTaskNode_Task(), this.getTask(), null, "task", null, 0, -1, TaskNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDecision_Transitioncondition(), ecorePackage.getEString(), "transitioncondition", null, 1, 1, Decision.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getEvent_Action(), this.getAction(), this.getAction_ParentEvent(), "action", null, 0, -1, Event.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(actionEClass, Action.class, "Action", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAction_JavaClass(), ecorePackage.getEString(), "javaClass", null, 1, 1, Action.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getAction_Expression(), ecorePackage.getEString(), "expression", null, 1, 1, Action.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getAction_ParentEvent(), this.getEvent(), this.getEvent_Action(), "parentEvent", null, 0, 1, Action.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getAction_ParentTimer(), this.getTimer(), this.getTimer_Action(), "parentTimer", null, 0, 1, Action.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getScript_Expression(), ecorePackage.getEString(), "expression", null, 0, 1, Script.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTask_Swimlane(), this.getSwimlane(), this.getSwimlane_Manage(), "swimlane", null, 1, 1, Task.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getTask_Assignment(), this.getAssignment(), null, "assignment", null, 0, -1, Task.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTask_Event(), this.getEvent(), null, "event", null, 0, -1, Task.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTask_Timer(), this.getTimer(), null, "timer", null, 0, -1, Task.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(timerEClass, Timer.class, "Timer", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTimer_Name(), ecorePackage.getEString(), "name", null, 1, 1, Timer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getTimer_Action(), this.getAction(), this.getAction_ParentTimer(), "action", null, 1, 1, Timer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(assignmentEClass, Assignment.class, "Assignment", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAssignment_Actorid(), ecorePackage.getEString(), "actorid", null, 1, 1, Assignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getAssignment_Pooledactors(), ecorePackage.getEString(), "pooledactors", null, 1, 1, Assignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getAssignment_Clazz(), ecorePackage.getEString(), "clazz", null, 1, 1, Assignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getTransition_To(), this.getTask(), null, "to", null, 1, 1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
