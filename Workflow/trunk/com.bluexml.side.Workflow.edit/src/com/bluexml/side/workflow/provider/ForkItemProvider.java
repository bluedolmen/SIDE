...
public class ForkItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WorkflowPackage.Literals.FORK__TRANSITION);
			childrenFeatures.add(WorkflowPackage.Literals.FORK__EVENT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.FORK__TRANSITION,
				 WorkflowFactory.eINSTANCE.createTransition()));

		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.FORK__EVENT,
