...
/**
 * This is the item provider adapter for a {@link com.bluexml.side.workflow.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskItemProvider
	...
	protected void addSwimlanePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_swimlane_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_swimlane_feature", "_UI_Task_type"),
				 WorkflowPackage.Literals.TASK__SWIMLANE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WorkflowPackage.Literals.TASK__ASSIGNMENT);
			childrenFeatures.add(WorkflowPackage.Literals.TASK__EVENT);
			childrenFeatures.add(WorkflowPackage.Literals.TASK__TIMER);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.TASK__ASSIGNMENT,
				 WorkflowFactory.eINSTANCE.createAssignment()));

		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.TASK__EVENT,
				 WorkflowFactory.eINSTANCE.createEvent()));

		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.TASK__TIMER,
