	...
	public void performRequest(Request request) {
		...
		if (request.getType() == RequestConstants.REQ_OPEN) {
			if (g.getEntryPoint() != null) {
				PrivilegeDialog dialog = new PrivilegeDialog(ModelerPlugin.getActiveWorkbenchShell(), g);
				...
				MessageDialog.openError(null, "No entry point!", "No entry point has been defined ! Check your model !");
		} else {
