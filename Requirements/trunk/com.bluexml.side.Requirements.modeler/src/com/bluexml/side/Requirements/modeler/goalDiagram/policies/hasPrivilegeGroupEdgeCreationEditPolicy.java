...
import com.bluexml.side.Requirements.modeler.goalDiagram.commands.hasPrivilegeGroupEdgeCreationCommand;

/**
 * hasPrivilegeGroup edge creation
 *
 * @generated
 */
public class hasPrivilegeGroupEdgeCreationEditPolicy extends
	...
	protected CreateTypedEdgeCommand createCommand(EditDomain domain,
		...
		return new hasPrivilegeGroupEdgeCreationCommand(domain, edge, source);
	}
	...
	protected boolean checkEdge(GraphEdge edge) {
		if (edge.getSemanticModel() instanceof SimpleSemanticModelElement) {
			return ReqSimpleObjectConstants.SIMPLE_OBJECT_HASPRIVILEGEGROUP
	...
	protected boolean checkTargetForSource(GraphElement source,
		...
		if (sourceObject instanceof com.bluexml.side.requirements.Goal
				&& targetObject instanceof com.bluexml.side.requirements.PrivilegeGroup) {
	...
	protected boolean checkCommand(Command command) {
		return command instanceof hasPrivilegeGroupEdgeCreationCommand;
	}
	...
	protected SourceTargetData getSourceTargetData(GraphElement source,
		...
		if (sourceObject instanceof com.bluexml.side.requirements.Goal
			...
			return new SourceTargetData(false, false, SourceTargetData.NONE,
					null, null, null, null, null, "privilegeGroup", null, null);
		}
		return null;
	}
