...
public class AgentDialog extends Dialog implements IDialogConstants {
	...
	public AgentDialog(Shell parent, Agent _agent) {
		super(parent);
		setBlockOnOpen(true);
	...
	private void loadData() {
		//Doc
		if (agent.getDocumentation() != null)
			documentation.setText(agent.getDocumentation());
	}
	...
	protected void okPressed() {
		...
		data.put(AGENT_DOCUMENTATION, documentation.getText());
		super.okPressed();
	}
