...
import com.bluexml.side.Requirements.modeler.goalDiagram.figures.hasPrivilegeGroupFigure;
import com.bluexml.side.Requirements.modeler.goalDiagram.preferences.ReqDiagramPreferenceConstants;

/**
 * hasPrivilegeGroup controller
 *
 * @generated
 */
public class hasPrivilegeGroupEditPart extends GraphEdgeEditPart {
	 ...
	 * @generated
	 */
	public hasPrivilegeGroupEditPart(GraphEdge model) {
		super(model);
	}
	...
	protected IFigure createFigure() {
		hasPrivilegeGroupFigure connection = new hasPrivilegeGroupFigure();
