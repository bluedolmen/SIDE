...
import com.bluexml.side.Requirements.modeler.goalDiagram.figures.isLinkedToEntityFigure;
import com.bluexml.side.Requirements.modeler.goalDiagram.preferences.ReqDiagramPreferenceConstants;

/**
 * isLinkedToEntity controller
 *
 * @generated
 */
public class isLinkedToEntityEditPart extends GraphEdgeEditPart {
	 ...
	 * @generated
	 */
	public isLinkedToEntityEditPart(GraphEdge model) {
		super(model);
	}
	...
	protected IFigure createFigure() {
		isLinkedToEntityFigure connection = new isLinkedToEntityFigure();
