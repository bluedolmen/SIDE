...
public class GoalDialog extends Dialog implements IDialogConstants {
	...
	public static final String GOAL_DOCUMENTATION = "goal documentation";

	public GoalDialog(Shell parent, Goal _goal) {
		super(parent);
		setBlockOnOpen(true);
	...
	private void loadData() {
		//Doc
		if (goal.getDocumentation() != null)
			documentation.setText(goal.getDocumentation());
	}
	...
	protected void okPressed() {
		...
		data.put(GOAL_DOCUMENTATION, documentation.getText());
		super.okPressed();
	}
