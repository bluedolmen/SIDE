...
public class GenerateKeySideShort extends JBPMSpringActionHandler {

	private static Logger logger = Logger.getLogger(GenerateKeySideShort.class);
	...
	private int setAttribute(String name) {
		try {
			...
			String expressionAttr = "/root/side/generate_short/"+name;
			String temp_attr = "";
	...
	public static InputStream GetResourceAsStream(String file) throws Exception {
    	InputStream myurl = GenerateKeySideShort.class.getClassLoader().getResourceAsStream("com/bluexml/side/Integration/licenses/LicenseMgmt/resources/xml/"+file);
		return myurl;
	}
}
