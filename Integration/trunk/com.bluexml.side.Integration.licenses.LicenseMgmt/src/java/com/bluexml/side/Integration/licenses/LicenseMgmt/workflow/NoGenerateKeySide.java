...
public class NoGenerateKeySide extends JBPMSpringActionHandler {

	private static Logger logger = Logger.getLogger(NoGenerateKeySide.class);
	...
	private int setAttribute(String name) {
		try {
			...
			String expressionAttr = "/root/side/no_generate/"+name;
			String temp_attr = "";
	...
	public static InputStream GetResourceAsStream(String file) throws Exception {
    	InputStream myurl = NoGenerateKeySide.class.getClassLoader().getResourceAsStream("com/bluexml/side/Integration/licenses/LicenseMgmt/resources/xml/"+file);
		return myurl;
	}
}
