		...
		<office:text>
			...
			<text:table-of-content text:style-name="Sect1"
				...
				<text:index-body>
                    ...
                    xlink:href="#2.<%name%> attributes|outline"><%name%> attributes</text:a><text:tab/>1</text:p>
						<text:p text:style-name="P2"><text:a xlink:type="simple"
                    xlink:href="#2.<%name%> associations|outline"><%name%> associations</text:a><text:tab/>1</text:p>
					<%}%>
				</text:index-body>
