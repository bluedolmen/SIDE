...
public class PluginsUpdater {
	...
	private void updateVersion(String pluginId) throws Exception {
		...
		// projet
		Properties openProperties = BuilderUtils.openProperties(filePluginPath);
		
		String property = openProperties.getProperty("Bundle-Version");
		String[] number = property.split("\\.");
