...
for f in `ls $SOURCE_PATH/S-IDE/Integration/trunk | grep -v -e 'com.bluexml.side.Integration.eclipse.branding' | grep -v -e 'com.bluexml.side.Integration.alfresco.sql' `
do
