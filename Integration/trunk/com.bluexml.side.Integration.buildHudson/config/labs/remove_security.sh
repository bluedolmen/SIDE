...
perl -p -i -e 's/SIDE Enterprise/SIDE Community Edition/g' $SOURCE_PATH/S-IDE/Integration/trunk/com.bluexml.side.Integration.eclipse.branding.labs/side.product
...
rm $SOURCE_PATH/S-IDE/Integration/trunk/com.bluexml.side.Integration.eclipse.branding.labs/splash.bmp
cp $SOURCE_PATH/S-IDE/Integration/trunk/com.bluexml.side.Integration.eclipse.branding.labs/splash-LABS.bmp $SOURCE_PATH/S-IDE/Integration/trunk/com.bluexml.side.Integration.eclipse.branding.labs/splash.bmp
